...
if (!defined('MAGICZOOMPLUS_MODULE_CORE_CLASS_LOADED')) {
    ...
    class MagicZoomPlusModuleCoreClass
    {
        ...
        public function getHeadersTemplate($jsPath = '', $cssPath = null)
        {
            ...
            $headers = array();
            $headers[] = '<!-- Magic Zoom Plus Prestashop module version v5.9.13 [v1.6.70:v5.2.5] -->';
        ...
        public function loadDefaults()
        {
            $params = array(
                ...
                'magicscroll'=>array('id'=>'magicscroll','group'=>'General','order'=>'22','default'=>'No','label'=>'Scroll thumbnails','description'=>'Powered by the versatile  for help.','type'=>'array','subType'=>'select','values'=>array('Yes','No'),'scope'=>'module'),
