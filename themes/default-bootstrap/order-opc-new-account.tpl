...
{assign var=default_city value='Vijayawada'}
{assign var=default_country value='IN'}
			...
			<div class="box">
				...
				<div id="opc_account_form" class="unvisible">
					...
					<div class="text form-group">
						...
						<input type="text" class="text form-control" id="email" name="email"  value="{if isset($guestInformations) && isset($guestInformations.email) && $guestInformations.email}{$guestInformations.email}{/if}" />
					</div>
					...
					<div class="hide select form-group date-select">
					...
					{/if}
					<h3 class="hide page-subheading top-indent">{l s='Delivery address'}</h3>
					{$stateExist = false}
					{$postCodeExist = false}
					{$dniExist = false}
					...
					<div class="hide required text form-group">
						<label for="firstname">{l s='First name'} <sup>*</sup></label>
...
{*						<input type="text" class="text form-control validate" name="address1" id="address1" data-validate="isAddress" value="{if isset($guestInformations) && isset($guestInformations.address1) && isset($guestInformations) && isset($guestInformations.address1) && $guestInformations.address1}{$guestInformations.address1}{/if}" /> *}
					...
					<div class="hide text form-group">
						<label for="city">{l s='City'} <sup>*</sup></label>
						<input type="text" class="text form-control validate" name="city" id="city" data-validate="isCityName" value="{$default_city}" />
					</div>
